      ...
      <div className="antialiased bg-gray-50 :bg-gray-900">
        ...
        >
          <div className="overflow-y-auto py-5 px-3 h-full bg-white :bg-gray-800">
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg :text-white hover:bg-gray-100 :hover:bg-gray-700 group"
                >
                  <svg
                    aria-hidden="true"
              ...
              <li>
                ...
                <ul id="dropdown-pages" className="hidden py-2 space-y-2">
                  <li>
                    <a
                      href="#"
                      className="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 :text-white :hover:bg-gray-700"
                    >
                      Settings
                    </a>
                  </li>
          ...
          <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white :bg-gray-800 z-20">
            <a
              href="#"
              className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer :text-gray-400 hover:text-gray-900 :hover:text-white hover:bg-gray-100 :hover:bg-gray-600"
            >
              <svg
                aria-hidden="true"
                className="w-6 h-6"
